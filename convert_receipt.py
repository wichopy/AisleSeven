#WC - Code from blogpost here: http://www.astrojack.com/scanning-and-ocr-ing-a-paper-receipt/
#WC- and tons of help from pyimagesearch: http://www.pyimagesearch.com/2014/09/01/build-kick-ass-mobile-document-scanner-just-5-minutes/
# USAGE
...
#WC- Was getting a "TOO MANY VALUES TO UNPACK" error on this line.
#WC - corrected thanks to this SO post http://stackoverflow.com/questions/27746089/python-computer-vision-contours-too-many-values-to-unpack
...
warped = threshold_adaptive(warped, 251, offset = 10)  #WC- CORRECTED THIS ERROR, 250 did not work, original code had 251.
